...
export const metadata = {
  ...
  description: `Secure your spot at ${currentEvent.title}. Secure checkout via Tito + Stripe.`,
};
    ...
    <div className="min-h-screen">
      ...
      <section className="section relative overflow-hidden">
        <div className="section-wide max-w-4xl">
            ...
            <div className="bg-zinc-900/30 border border-zinc-800 rounded-2xl p-6 rave-glow inline-block">
              <div className="flex flex-col lg:flex-row items-center gap-6 text-center lg:text-left">
                <div>
                  ...
                  <div className="text-pink-400 font-semibold">{currentEvent.time}</div>
                </div>
          ...
          {/* Tagline + optional genres */}
          <div className="text-center mb-8">
            {currentEvent.musicGenres.length > 0 && (
              <>
                ...
                <div className="flex flex-wrap justify-center gap-3 mb-6">
                  {currentEvent.musicGenres.map((genre) => (
                    <span
                      key={genre}
                      className="px-4 py-2 bg-pink-500/20 border border-pink-500/30 rounded-full text-pink-300 font-semibold text-sm uppercase tracking-wider pulse-border"
                    >
                      {genre}
                    </span>
                  ))}
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-zinc-900/50 border border-zinc-700 rounded-xl p-6 text-center rave-glow">
                <div className="text-pink-400 font-bold text-sm uppercase tracking-wider mb-2">Early Energy</div>
              ...
              <div className="bg-zinc-900/50 border border-zinc-700 rounded-xl p-6 text-center rave-glow">
                <div className="text-pink-400 font-bold text-sm uppercase tracking-wider mb-2">Peak Vibes</div>
              ...
              <div className="bg-zinc-900/50 border border-zinc-700 rounded-xl p-6 text-center rave-glow">
                <div className="text-pink-400 font-bold text-sm uppercase tracking-wider mb-2">Last Chance</div>
          ...
          <div className="bg-zinc-900/30 border border-zinc-800 rounded-xl p-6 mb-8">
            <h3 className="text-lg font-bold mb-4 text-pink-400 uppercase tracking-wider">Important Info</h3>
          ...
          <div className="text-center text-xs text-zinc-500 max-w-2xl mx-auto">
            ...
            <p>
              Questions? Email us or find us at the venue.
            </p>
          </div>
        </div>
